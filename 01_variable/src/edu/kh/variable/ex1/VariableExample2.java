...
public class VariableExample2 {
	...
	public static void main(String[] args) {
		...
		// -> boolean의 리터럴 표기법은 true / false 만 저장할 수 있다.
		// booleanData = '가'; - mismatch '가'는 char형 
		
		iNum = 1000000; // 100만
		// -> int의 리터럴 표기법은 기본적인 정수 표기법
		// iNum = 10000000000; - The literal 10000000000 of type int is out of range 
		
		longNum = 10000000000L;
		// longNum = 10000000000; - The literal 10000000000 of type int is out of range
		// (10000000000는 int 표기법이므로 int의 최대 크기를 넘어 설 수 없다.) 
		...
		// char의 리터럴 표기법은 ''(홑따옴표)
	    ch2 = 67;
	    // char 자료형은 숫자-문자 (아스키코드 65 = A) 형태의 문자표에서 
