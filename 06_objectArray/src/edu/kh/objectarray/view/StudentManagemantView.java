...
import edu.kh.objectarray.model.service.StudentManagemantService;
import edu.kh.objectarray.model.vo.Student;

// 화면 제공용 클래스(입/출력)

public class StudentManagemantView {
	
	// 필드 ==  멤버변수
	private Scanner sc = new Scanner(System.in);
	
	private StudentManagemantService service = new StudentManagemantService();
	...
	public void displayMenu() {
		...
		do {
			...
			case 0 : System.out.print("프로그램을 종료합니다."); break;
			default : System.out.print("잘못 입력 하셨습니다.");
			}
	...
	public void printAll() {
		...
		// 서비스 객체필드에 존재하는 stdArr의 값(Student[] 참조 주소)
