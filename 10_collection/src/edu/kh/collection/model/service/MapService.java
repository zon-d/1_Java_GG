...
public class MapService {
	...
	public void ex2() {
		...
		std.setName("홍길동"); // vo 패키지 표기법
		student.put("name", "홍길동"); // map 표기법
		...
		System.out.println(std); // vo =- value object == 값을 다루기로 한 오브젝트
	...
	public void ex3() {
										 // TreeMap : 실행 결과의 n회를 순서대로 출력함 (import까지 해야함)
		Map<String, Set<Integer>> map = new HashMap<>(); // 타입 추론 : 참조 변수의 제네릭을 보고
// Map 안에 string set 존재, set안의 값이 integer                          생성되는 컬렉션 객체의 제네릭을 추측함
																	// (Hashmap의 제네릭 안에 값을 안넣어도 되는 이유)
