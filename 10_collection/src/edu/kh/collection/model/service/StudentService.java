...
public class StudentService {
	...
	public StudentService() {
		...
		stdList.add(new Student("정지윤", 25, "성남시 분당구", 'F', 0));
		stdList.add(new Student("정철수", 1, "안산시 단원구", 'M', 100));
...
//		Student std = new Student(name, age, address, gender, score);
	 ...
	 * false : 인덳가 일치하는 학생이 없을 경우
	 * */
	public boolean updateStudent(int idx, String adress, int score) {
		...
		if( idx  >=  stdList.size() || idx < 0 ) {
			...
			stdList.get(idx).setAddress(adress);
